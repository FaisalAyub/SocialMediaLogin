...
namespace BoilerPlaitApp.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = BoilerPlaitAppConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(BoilerPlaitAppDbContext context)
        {
            _context = context;
        }
