...
{
    public abstract class BoilerPlaitAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BoilerPlaitAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BoilerPlaitAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BoilerPlaitAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BoilerPlaitAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BoilerPlaitAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BoilerPlaitAppDbContext, Task<T>> func)
        {
            T result;
